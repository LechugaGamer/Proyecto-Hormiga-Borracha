...
class Laberinto:
    ...
    def obtener_objeto_en_celda(self, fila, columna): #Metodo que retorna el objeto (letra) en la posicion de la matriz
        return self.matriz[fila][columna].cget("text") if (0 <= fila < len(self.matriz) and 0 <= columna < len(self.matriz[0])) else None
